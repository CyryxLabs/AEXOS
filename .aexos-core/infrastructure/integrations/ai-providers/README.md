...
Multi-provider AI integration for AEXOS. Supports Claude Code, Gemini CLI and OpenAI-compatible HTTP APIs with automatic fallback and task-based routing.
...
Create `.aexos-ai-config.yaml` in project root:
