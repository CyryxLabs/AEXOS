# AEXOS Service Registry

The Service Registry is the central catalog of all workers, tasks, templates, scripts, and workflows in the AEXOS framework. It enables service discovery, search, and reuse across the system.
...
The builder scans:
- `.aexos-core/development/tasks/**/*.md` → task
- `.aexos-core/product/templates/**/*.md` → template
- `.aexos-core/infrastructure/scripts/**/*.js` → script
- `.aexos-core/product/checklists/**/*.md` → checklist
- `.aexos-core/development/workflows/**/*.yaml` → workflow
- `.aexos-core/core/data/**/*` → data
...
*Generated by AEXOS Framework v4.0.4*
