...
const ISSUE_URL = 'https://github.com/CyryxLabs/AEXOS/issues/773';
...
function getWindowsNpxInstallHint(opts = {}) {
  ...
  const message = [
    ...
    '│   1) npm install -g @aexos-squads/core                           │',
    '│      then: aexos-core install                                   │',
    '│   2) git clone … && npm install && node bin/aexos.js install    │',
