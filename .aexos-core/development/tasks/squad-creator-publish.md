...
Publishes a local squad to the aexos-squads GitHub repository via Pull Request.
...
Publishing: my-squad@1.0.0
  ...
  Target: github.com/CyryxLabs/aexos-squads
...
Pull Request Created!
  URL: https://github.com/CyryxLabs/aexos-squads/pull/42
  Branch: squad/my-squad
...
4. Create/check fork
   └── Fork CyryxLabs/aexos-squads if needed
