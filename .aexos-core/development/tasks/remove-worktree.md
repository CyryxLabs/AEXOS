...
Removes an AEXOS-managed worktree and its associated branch. Includes safety checks for uncommitted changes and provides options for force removal.
...
Options:
  1. Commit changes first    : cd .aexos/worktrees/{storyId} && git commit
...
You are about to remove:
  • Worktree: .aexos/worktrees/{storyId}
  • Branch:   auto-claude/{storyId}
...
1. `git worktree remove .aexos/worktrees/{storyId}`
...
❌ Cannot remove worktree while inside it.
   ...
   Current directory: .aexos/worktrees/{storyId}
