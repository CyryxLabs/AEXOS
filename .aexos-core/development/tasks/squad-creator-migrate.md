...
Migrates legacy squad formats to AEXOS 2.1 standard.
...
| Missing `cyryx.type` | Field not present | Add `cyryx.type: squad` |
| Missing `cyryx.minVersion` | Field not present | Add `cyryx.minVersion: 2.1.0` |
...
───────────────────────────────────────────────────────────
  ...
  ❌ [ERROR] Missing required field: cyryx.type
  ❌ [ERROR] Missing required field: cyryx.minVersion
...
───────────────────────────────────────────────────────────
  ...
  3. Add field: cyryx.type = "squad"
  4. Add field: cyryx.minVersion = "2.1.0"
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    ✅ Add field: cyryx.type = "squad" [success]
    ✅ Add field: cyryx.minVersion = "2.1.0" [success]
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    🔍 Add field: cyryx.type = "squad" [dry-run]
    🔍 Add field: cyryx.minVersion = "2.1.0" [dry-run]
...
- **Schema:** .aexos-core/schemas/squad-schema.json
- **Agent:** @squad-creator (Arkantos)
