...
Cria um novo squad seguindo a arquitetura task-first do AEXOS.
...
🚀 When ready to share:
   ...
   - API: @squad-creator *sync-squad-cyryx meu-dominio-squad
```
...
```javascript
const { SquadGenerator } = require('./.aexos-core/development/scripts/squad');
