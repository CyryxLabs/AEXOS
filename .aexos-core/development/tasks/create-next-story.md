...
responsável: Chronos (Facilitator)
...
- **Tool:** component-generator
  ...
  - **Source:** .aexos-core/scripts/component-generator.js
...
- **Script:** create-component.js
  ...
  - **Language:** JavaScript
  - **Location:** .aexos-core/scripts/create-component.js
...
- **If available:**
  - Call `detectDuplicateStory(storyDescription)` from `.aexos-core/core/code-intel/helpers/story-helper`
  ...
  - Call `suggestRelevantFiles(storyDescription)` from `.aexos-core/core/code-intel/helpers/story-helper`
