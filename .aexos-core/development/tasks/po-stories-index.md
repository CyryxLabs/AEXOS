...
```javascript
const { generateStoryIndex } = require('.aexos-core/scripts/story-index-generator');
...
{
  "scripts": {
    "stories:index": "node .aexos-core/scripts/story-index-generator.js docs/stories"
  }
}
```
