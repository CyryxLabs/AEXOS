...
```javascript
const { isCodeIntelAvailable } = require('.aexos-core/core/code-intel');
const { getCodebaseOverview, getDependencyGraph } = require('.aexos-core/core/code-intel/helpers/planning-helper');
