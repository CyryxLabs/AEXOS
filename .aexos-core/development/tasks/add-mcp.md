...
### 7. Update AEXOS Documentation (REQUIRED)
...
**CRITICAL NOTE:** Tools added to Docker MCP Toolkit are NOT immediately available to AEXOS agents. The docker-gateway caches tools at Claude Code startup. User MUST restart their Claude Code session for new tools to appear.
...
changelog:
  ...
  1.2.0:
    - Added: Steps 7-9 for AEXOS documentation and session restart
    ...
    - Fixed: Tools not appearing in AEXOS agents after MCP addition
  1.1.0:
