...
const { RegistryLoader } = require(path.resolve('.aexos-core/core/ids/registry-loader'));
const { IncrementalDecisionEngine } = require(path.resolve('.aexos-core/core/ids/incremental-decision-engine'));
