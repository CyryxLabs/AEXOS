...
3. Choose the AEXOS agent mode you need

### Available Agent Modes
| Mode | Purpose |
|------|---------|
| aexos-dev | Full-stack development |
| aexos-qa | Quality assurance |
| aexos-architect | System design |
| aexos-pm | Project management |
