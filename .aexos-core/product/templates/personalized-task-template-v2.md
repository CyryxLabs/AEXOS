...
- **Builder (Vulcan):** "✅ Implementei com sucesso. {detail}."
- **Guardian (Argus):** "✅ Validado rigorosamente. {detail}."
- **Balancer (Themis):** "✅ Equilibrei todas as dependências. {detail}."
...
```yaml
**Scripts:**
- .aexos-core/scripts/dev-specific/test-runner.js:
    description: Runs tests with coverage reporting specific to dev agent
    language: javascript
    version: 1.2.0

- .aexos-core/scripts/qa-specific/regression-validator.js:
...
- fallback: |
    ...
    2. Use generic template from .aexos-core/product/templates/
...
- fallback: |
    ...
    1. Check alternative data sources (.aexos-core/data/)
...
- **CRITICAL:** Follow AEXOS Task Format Specification V1.0 exactly
...
- See `.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md` for complete spec
- See `.aexos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for personality guidelines

---

**Template Version:** 2.0
**Last Updated:** 2025-01-14
**Applies to:** All tasks with AEXOS Task Format V1.0 + Personalized Agents (Story 6.1.2+)
