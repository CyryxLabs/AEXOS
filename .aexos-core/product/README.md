...
```javascript
const templatePath = '.aexos-core/product/templates/story-tmpl.yaml';
const checklistPath = '.aexos-core/product/checklists/story-dod-checklist.md';
```
