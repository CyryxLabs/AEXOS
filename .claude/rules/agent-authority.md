...
### @devops (Polaris) — EXCLUSIVE Authority
...
### @architect (Vega) — Design Authority
...
### @aexos-master — Framework Governance
...
1. Agent cannot complete task → Escalate to @aexos-master
...
4. Agent boundary conflict → @aexos-master mediates
