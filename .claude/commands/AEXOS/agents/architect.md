...
1. Read `.claude/skills/AEXOS/agents/architect/SKILL.md` in full.
2. Follow the activation instructions from that skill.
3. If the skill file is unavailable, read `.aexos-core/development/agents/architect.md` as fallback.
