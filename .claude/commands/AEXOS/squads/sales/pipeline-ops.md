...
1. Read `.claude/skills/AEXOS/squads/sales/pipeline-ops/SKILL.md` in full.
2. Follow the activation instructions from that skill.
3. If the skill file is unavailable, read `squads/sales/agents/pipeline-ops.md` as fallback.
