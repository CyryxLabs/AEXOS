...
1. Read `.claude/skills/AEXOS/squads/business-admin/people-lead/SKILL.md` in full.
2. Follow the activation instructions from that skill.
3. If the skill file is unavailable, read `squads/business-admin/agents/people-lead.md` as fallback.
