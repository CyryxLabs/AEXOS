...
### Added
- 8 specialist agents: claude-mastery-chief (Warden), hooks-architect (Latch), mcp-integrator (Piper), swarm-orchestrator (Nexus), config-engineer (Sigil), skill-craftsman (Anvil), project-integrator (Conduit), roadmap-sentinel (Vigil)
...
- CYRYX-core integration bridge (agents, tasks, hooks, config mapping)

### Architecture
- Entry agent: claude-mastery-chief (Warden) with 7-domain routing matrix
- Cross-cutting concern: all agents understand CYRYX-core architecture
