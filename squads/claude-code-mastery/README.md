...
| 2 | project-integrator | Conduit | Daniel Miessler (PAI) | 959 | Project integration, CI/CD, AEXOS bridge |
...
```
/AEXOS:agents:claude-mastery-chief
```

### Direct Specialist Access
```
/AEXOS:agents:hooks-architect        # Hook automation
/AEXOS:agents:mcp-integrator         # MCP servers
/AEXOS:agents:swarm-orchestrator     # Multi-agent orchestration
/AEXOS:agents:config-engineer        # Settings & permissions
/AEXOS:agents:skill-craftsman        # Skills & plugins
/AEXOS:agents:project-integrator     # Project integration
/AEXOS:agents:roadmap-sentinel       # Updates & roadmap
```
...
| AEXOS Bridge | Orion + Conduit | `*aexos-bridge`, `*aexos-guide` |
...
This squad understands both Claude Code native capabilities AND the CYRYX-core framework:

| AEXOS Concept | Claude Code Equivalent | Bridge Agent |
|-------------|----------------------|-------------|
| Agents (@dev, @qa...) | Subagents (.claude/agents/) | Nexus |
| Tasks (.aexos-core/tasks/) | Skills (.claude/skills/) | Anvil |
...
├── README.md                      # This file
├── agents/
│   ├── claude-mastery-chief.md    # Tier 0: Orchestrator (Warden)
