...
- Generated files in `.gemini/rules.md`, `.gemini/rules/AEXOS/agents/`, and `.gemini/commands/*.toml`
- ✅ Local hooks and settings in the installation flow (`.gemini/hooks/` + `.gemini/settings.json`)
- ✅ Quick activation via slash commands (`/aexos-menu`, `/aexos-dev`, `/aexos-architect`, etc.)
...
Next steps:
  ...
  aexos-core doctor     # Verify installation
  aexos-core --help     # See available commands
```
...
Run 'aexos-core <command> --help' for detailed information about each command.
```
...
- **aexos-master** - Master orchestration agent (includes framework development capabilities)
- **aexos-orchestrator** - Workflow orchestrator and team coordination
...
- 🐛 [Issue Tracker](https://github.com/CyryxLabs/AEXOS/issues) - Bug reports and feature requests
...
[![Contributors](https://contrib.rocks/image?repo=CyryxLabs/aexos-core)](https://github.com/CyryxLabs/AEXOS/graphs/contributors)

<sub>Built with ❤️ for the AI-assisted development community</sub>

---

**[⬆ Back to top](#aexos-squad-artificial-intelligence-orchestration-experience)**
