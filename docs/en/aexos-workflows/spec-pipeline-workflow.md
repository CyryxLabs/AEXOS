...
> **EN** | [PT](../../aexos-workflows/spec-pipeline-workflow.md) | [ES](../../es/aexos-workflows/spec-pipeline-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../aexos-workflows/spec-pipeline-workflow.md)
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../aexos-workflows/spec-pipeline-workflow.md).*
