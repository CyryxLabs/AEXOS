...
> **EN** | [PT](../../aexos-workflows/greenfield-service-workflow.md) | [ES](../../es/aexos-workflows/greenfield-service-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../aexos-workflows/greenfield-service-workflow.md)
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../aexos-workflows/greenfield-service-workflow.md).*
