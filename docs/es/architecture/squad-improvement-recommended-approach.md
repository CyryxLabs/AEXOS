...
```yaml
task: analyzeSquad()
responsible: squad-creator (Arkantos)
...
|-----|--------|-------------------|
| Principal | @dev (Vulcan) | Implementar scripts y tareas |
| Soporte | @qa (Argus) | Probar implementacion |
| Revision | @architect (Vega) | Revision de arquitectura |
