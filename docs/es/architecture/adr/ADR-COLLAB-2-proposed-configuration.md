...
**Fecha:** 2025-12-30
**Estado:** Propuesto
**Autor:** @devops (Polaris) + @architect (Vega)
...
```bash
gh api repos/CyryxLabs/AEXOS/branches/main/protection -X PUT \
...
# ============================================
* @CyryxLabs/maintainers

# ============================================
# Framework Core
# ============================================
# Definiciones de agentes - requiere revision del equipo core
.aexos-core/development/agents/ @CyryxLabs/core-team

# Definiciones de tareas - requiere revision del equipo core
.aexos-core/development/tasks/ @CyryxLabs/core-team

# Definiciones de workflows - requiere revision del equipo core
.aexos-core/development/workflows/ @CyryxLabs/core-team

# Plantillas - requiere revision de arquitecto/equipo core
.aexos-core/product/templates/ @CyryxLabs/core-team
templates/ @CyryxLabs/core-team

# Utilidades core - requiere revision senior
.aexos-core/core/ @CyryxLabs/core-team
.aexos-core/cli/ @CyryxLabs/core-team

# ============================================
# Infraestructura
# ============================================
# CI/CD - requiere aprobacion de devops
.github/ @CyryxLabs/devops

# Configuraciones de Docker
.docker/ @CyryxLabs/devops

# Archivos de configuracion
.aexos-core/core-config.yaml @CyryxLabs/core-team
package.json @CyryxLabs/maintainers
package-lock.json @CyryxLabs/maintainers

# ============================================
# Documentacion (Mas Permisiva)
# ============================================
# Documentacion general - mantenedores pueden aprobar
docs/ @CyryxLabs/maintainers

# Decisiones de arquitectura - requiere equipo core
docs/architecture/ @CyryxLabs/core-team
docs/framework/ @CyryxLabs/core-team

# Historias - mantenedores (documentacion de desarrollo interno)
docs/stories/ @CyryxLabs/maintainers

# Guias - mantenedores (amigable para contribuidores)
docs/guides/ @CyryxLabs/maintainers

# ============================================
# Archivos Sensibles de Seguridad
# ============================================
# Configuraciones de seguridad
.github/CODEOWNERS @CyryxLabs/core-team
.github/workflows/semantic-release.yml @CyryxLabs/devops
.github/workflows/npm-publish.yml @CyryxLabs/devops

# Archivos de configuracion raiz
.env* @CyryxLabs/core-team
*.config.js @CyryxLabs/maintainers
```

**Equipos de GitHub Requeridos:**

- `@CyryxLabs/maintainers` - Mantenedores generales (acceso de escritura)
- `@CyryxLabs/core-team` - Desarrolladores core del framework
- `@CyryxLabs/devops` - CI/CD e infraestructura
...
gh api -X DELETE repos/CyryxLabs/AEXOS/branches/main/protection
...
echo "* @CyryxLabs" > .github/CODEOWNERS
