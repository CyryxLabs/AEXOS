...
│   ┌─────────────────────────────────────────────────────────────────┐   │
│   │                        CLI / HERRAMIENTAS                        │   │
│   │  (cyryx agents, cyryx tasks, cyryx squads, cyryx workflow)          │   │
│   └─────────────────────────────────────────────────────────────────┘   │
│                                │                                        │
│          ┌────────────────────┼────────────────────┐                   │
│          │                    │                    │                   │
...
| --------------------- | ----------- | -------------- |
| `@cyryx/core`          | npm público | MIT            |
| `@cyryx/squad-etl`     | npm público | MIT            |
| `@cyryx/squad-creator` | npm público | MIT            |
| `@cyryx/squad-mmos`    | npm público | MIT            |
| `@cyryx/mcp-presets`   | npm público | Apache 2.0     |
...
| ------ | --------------- | ------------ | -------------------------- |
| Vulcan    | `dev`           | Constructor  | Implementación de código   |
| Argus  | `qa`            | Guardián     | Aseguramiento de calidad   |
| Vega   | `architect`     | Arquitecto   | Arquitectura técnica       |
| Nova   | `po`            | Visionario   | Backlog de producto        |
| Kai    | `pm`            | Equilibrador | Estrategia de producto     |
| Chronos  | `sm`            | Facilitador  | Facilitación de procesos   |
| Zara   | `analyst`       | Explorador   | Análisis de negocio        |
| Ceres   | `data-engineer` | Arquitecto   | Ingeniería de datos        |
