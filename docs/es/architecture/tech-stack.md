...
| ------- | ---------- | -------------------------------------------------------------------------------------------- | ---------------- |
| 1.0     | 2025-01-15 | Documentacion inicial del tech stack                                                         | Vega (architect) |
| 1.1     | 2025-12-14 | Actualizado aviso de migracion a CyryxLabs/AEXOS, semantic-release a v25.0.2 [Story 6.10] | Vulcan (dev)        |
