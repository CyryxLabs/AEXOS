...
**Aviso de Migracion:** Este documento migrara al repositorio `CyryxLabs/AEXOS` en Q2 2026 (ver Decision 005)
...
│
├── stories/                           # Historias de desarrollo
│   ├── cyryx migration/                # Historias de migracion AEXOS
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
### REPO 4: CyryxLabs/certified-partners (Privado)
...
### REPO 5: CyryxLabs/mmos (Privado + NDA)
...
Ejemplo: docs/stories/cyryx migration/story-6.1.2.6.md
...
| ------- | ---------- | ------------------------------------------------------------------------------------------------- | ---------------- |
| 1.0     | 2025-01-15 | Documentacion inicial de arbol de codigo                                                          | Vega (architect) |
| 1.1     | 2025-12-14 | Actualizada org a CyryxLabs, reemplazados Paquetes de Expansion con sistema de Squads [Story 6.10] | Vulcan (dev)        |
