...
**Autor:** @architect (Vega) vía @dev (Vulcan)
...
{
  "cyryx.healthCheck.enabled": true,
  "cyryx.healthCheck.interval": 300,
  "cyryx.healthCheck.mode": "quick",
  "cyryx.healthCheck.showNotifications": true
}
```
