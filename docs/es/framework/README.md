...
**Objetivo de Migración:** Q2 2026 → repositorio `CyryxLabs/AEXOS`
...
**IMPORTANTE**: Estos documentos ahora están en el repositorio `CyryxLabs/AEXOS`. La migración desde la antigua organización `cyryx/aexos-core` se completó en diciembre de 2024 como parte del OSR-9 (Architecture Core).

### Cronograma de Migración

- **Fase 1 (Q1 2026 - Story 6.1.2.6):** Documentación del framework separada en `docs/framework/`
- **Fase 2 (Q4 2024):** Repositorio migrado a `CyryxLabs/AEXOS` (OSR-9)
...
- **Ciclo de vida**: Reside en el repositorio `CyryxLabs/AEXOS`
