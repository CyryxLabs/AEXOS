...
│   ├── cyryx migration/                # Stories de migración AEXOS
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
| ------- | ---------- | -------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| 1.0     | 2025-01-15 | Documentación inicial del árbol de código fuente                                                                           | Vega (architect) |
| 1.1     | 2025-12-14 | Actualizada org a CyryxLabs, reemplazado Squads con sistema de Squads [Story 6.10]                                          | Vulcan (dev)        |
| 2.0     | 2025-12-15 | Actualización mayor para reflejar arquitectura modular (cli/, core/, development/, infrastructure/, product/) [Story 6.13] | Themis (PO)         |
