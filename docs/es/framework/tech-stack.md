...
**Aviso de Migración:** Este documento migrará al repositorio `CyryxLabs/AEXOS` en Q2 2026 (ver Decision 005)
...
| ------- | ---------- | -------------------------------------------------------------------------------------------- | ---------------- |
| 1.0     | 2025-01-15 | Documentación inicial del stack tecnológico                                                  | Vega (architect) |
| 1.1     | 2025-12-14 | Actualizado aviso de migración a CyryxLabs/AEXOS, semantic-release a v25.0.2 [Story 6.10] | Vulcan (dev)        |
