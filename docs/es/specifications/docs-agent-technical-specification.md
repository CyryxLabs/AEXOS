...
Entrada:
  ...
  - campo: agent_definition_path
    ...
    obligatorio: false
    example: "squads/cyryx/agents/dev/agent.yaml"
...
if echo "$changed_files" | grep -qE "^(src/|aexos-core/)"; then
  ...
  cyryx agent invoke @docs --task update-educational-docs \
    --files "$changed_files" \
    --mode interactive
  ...
  qa-docs:
    ...
    steps:
      ...
      - name: Ejecutar QA de Documentacion
        id: qa
        run: |
          cyryx agent invoke @docs --task qa-documentation \
            --paths "docs/**/*.md" \
...
- [ ] Crear `squads/cyryx/agents/docs/agent.yaml`
...
|---|--------|--------|-----|-----------|-------|
| 1 | @dev | Vulcan | Constructor | Acuario | Cian |
| 2 | @qa | Argus | Guardian | Virgo | Verde |
| 3 | @po | Themis | Equilibrador | Libra | Amarillo |
| 4 | @pm | Janus | Estratega | Capricornio | Gris |
| 5 | @sm | Chronos | Facilitador | Piscis | Cian |
| 6 | @architect | Vega | Visionario | Sagitario | Magenta |
| 7 | @analyst | Sirius | Decodificador | Escorpio | Rojo |
| 8 | @ux-design-expert | Iris | Empatizador | Cancer | Verde |
| 9 | @data-engineer | Ceres | Sabio | Geminis | Amarillo |
| 10 | @devops | Polaris | Automatizador | Tauro | Verde |
| 11 | **@docs** | **Ajax** | **Estratega de Contenido** | **Aries** | **Azul** |
| 12 | ~~@security~~ | ~~Apex~~ | ~~Conductor~~ | ~~Leo~~ | ~~Rojo~~ (CANCELADO) |
| 13 | @aexos-master | Zeus | Comandante | Aries | Cian |
...
**Especificacion Aprobada Por:** Architect (Vega)
