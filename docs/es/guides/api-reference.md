...
| ---------------- | ------ | ------------ | ---------------------------------------------- |
| `@dev`           | Vulcan    | Builder      | Implementación de código, depuración, pruebas  |
| `@qa`            | Argus  | Guardian     | Aseguramiento de calidad, revisión de código   |
| `@architect`     | Vega   | Visionary    | Arquitectura de sistemas, diseño de API        |
| `@pm`            | Janus | Strategist   | Requisitos de producto, épicas, estrategia     |
| `@po`            | Themis    | Champion     | Gestión de backlog, criterios de aceptación    |
| `@sm`            | Chronos  | Facilitator  | Planificación de sprints, creación de stories  |
| `@analyst`       | Sirius  | Explorer     | Investigación de mercado, análisis competitivo |
| `@data-engineer` | Ceres   | Architect    | Esquema de BD, migraciones, consultas          |
| `@devops`        | Polaris   | Optimizer    | CI/CD, despliegue, operaciones git             |
| `@ux-expert`     | Uma    | Creator      | Diseño UI/UX, wireframes                       |
| `@aexos-master`   | Zeus  | Orchestrator | Orquestación del framework, meta-operaciones   |
...
# Salida:
# 💻 Vulcan (Builder) listo. ¡Construyamos algo genial!
#
# **Comandos Rápidos:**
...
_AEXOS (Cyryx) API Reference v4.2.11_
