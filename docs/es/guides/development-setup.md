...
1. Navega a [github.com/CyryxLabs/AEXOS](https://github.com/CyryxLabs/AEXOS)
...
- Etiquetar `@CyryxLabs/core-team` para issues urgentes
...
_AEXOS (Cyryx) Guia de Configuracion para Desarrollo v1.0.0_
