...
2. **Marketplace de AEXOS** - Squads premium via API de AEXOS
...
| **Compatibilidad AEXOS** | `cyryx.minVersion: "2.1.0"` o superior |
...
Esto:
1. Hara fork de `CyryxLabs/aexos-squads` (si es necesario)
...
## Publicando en el Marketplace de AEXOS
...
- **Preguntas**: [Discusiones de GitHub](https://github.com/CyryxLabs/AEXOS/discussions)
- **Issues**: [Rastreador de Issues](https://github.com/CyryxLabs/AEXOS/issues)
