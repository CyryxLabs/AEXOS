...
| ---------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| **@analyst** (Sirius)         | 🔍    | Investigación de mercado, análisis competitivo, brainstorming, extracción de patrones                                 | Creación de PRD, arquitectura, stories             |
| **@pm** (Janus)             | 📋    | PRD, epics, estrategia de producto, recopilación de requisitos, escritura de specs                                    | Investigación, arquitectura, stories detalladas    |
| **@architect** (Vega)        | 🏛️    | Arquitectura de sistema, diseño de API, stack tecnológico, evaluación de complejidad, planificación de implementación | Investigación, PRD, esquema de base de datos       |
| **@data-engineer** (Ceres)    | 📊    | Esquema de base de datos, RLS, migraciones, optimización de queries                                                   | Arquitectura de app, selección de tecnología de BD |
| **@sm** (Chronos)              | 🌊    | User stories, planificación de sprint, refinamiento de backlog                                                        | PRD, epics, investigación, implementación          |
| **@dev** (Vulcan)               | 💻    | Implementación de story, codificación, pruebas, ejecución de subtasks, recuperación                                   | Creación de story, deploy                          |
| **@qa** (Argus)              | 🧪    | Code review, pruebas, garantía de calidad, crítica de spec, revisión estructurada                                     | Implementación                                     |
| **@po** (Themis)                | 🎯    | Gestión de backlog, criterios de aceptación, priorización                                                             | Creación de epic, arquitectura                     |
| **@ux-design-expert** (Nova) | 🎨    | Diseño UI/UX, wireframes, design systems                                                                              | Implementación                                     |
| **@devops** (Polaris)           | ⚙️    | Git ops, creación de PR, deploy, CI/CD, gestión de worktrees, migraciones                                             | Git local, implementación                          |
| **@aexos-master** (Zeus)     | 👑    | Desarrollo del framework, orquestación multi-agente                                                                   | Tareas rutinarias (usar agentes especializados)    |

---

## 🤖 Comandos ADE por Agente (v2.2.0)

### @devops (Polaris) - Infraestructura & Operaciones
...
### @architect (Vega) - Arquitectura de Sistema
...
### @analyst (Sirius) - Investigación & Análisis
