...
| Campo de tipo AEXOS    | Faltante      | `cyryx.type: squad`         |
| Version minima        | Faltante      | `cyryx.minVersion: "2.1.0"` |
...
- Agrega campos `cyryx` faltantes al manifiesto
...
- [ ] `cyryx.type` es `"squad"`
- [ ] `cyryx.minVersion` es `"2.1.0"` o superior
