...
| --------- | ---------------- | ------------ | -------------------------- |
| **Vulcan**   | `@dev`           | Constructor  | Implementacion de codigo   |
| **Argus** | `@qa`            | Guardian     | Aseguramiento de calidad   |
| **Vega**  | `@architect`     | Arquitecto   | Arquitectura tecnica       |
| **Nova**  | `@po`            | Visionario   | Backlog del producto       |
| **Kai**   | `@pm`            | Equilibrador | Estrategia del producto    |
| **Chronos** | `@sm`            | Facilitador  | Facilitacion de procesos   |
| **Zara**  | `@analyst`       | Explorador   | Analisis de negocio        |
| **Ceres**  | `@data-engineer` | Arquitecto   | Ingenieria de datos        |
| **Felix** | `@devops`        | Optimizador  | CI/CD y operaciones        |
| **Iris**   | `@ux-expert`     | Creador      | Experiencia de usuario     |
| **Themis**   | `@aexos-master`   | Orquestador  | Orquestacion del framework |

### Activacion de Agentes

```bash
# Activar un agente usando sintaxis @
@dev                # Activar Vulcan (Desarrollador)
@qa                 # Activar Argus (QA)
@architect          # Activar Vega (Arquitecto)
@aexos-master        # Activar Themis (Orquestador)
