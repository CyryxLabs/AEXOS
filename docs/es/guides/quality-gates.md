...
| **Argus (@qa)** | Revisión de QA automatizada | CRÍTICO              |
...
| Argus bloqueó         | Revisar feedback de @qa, actualizar código         |
