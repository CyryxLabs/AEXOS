...
│  Nivel 2: AEXOS-SQUADS  → github.com/CyryxLabs (Publico/Gratis)│
│  Nivel 3: AEXOS API   → api.cyryx.dev      (Marketplace)   │
└─────────────────────────────────────────────────────────────┘
```
...
| -------------------------------------------------------------------------- | ------- | ------------------------------------- |
| [etl-squad](https://github.com/CyryxLabs/aexos-squads/tree/main/etl)         | 2.0.0   | Recoleccion y transformacion de datos |
| [creator-squad](https://github.com/CyryxLabs/aexos-squads/tree/main/creator) | 1.0.0   | Utilidades de generacion de contenido |
...
Esto crea un PR a [CyryxLabs/aexos-squads](https://github.com/CyryxLabs/aexos-squads).

### Nivel 3: Marketplace de AEXOS
...
3. **Agregar Campos** - `cyryx.type`, `cyryx.minVersion`
...
# - cyryx.type: debe ser "squad"
# - cyryx.minVersion: debe ser semver valido
```
...
3. Re-publicar: `*publish-squad` o `*sync-squad-cyryx`
...
- **Nivel 3**: Sincronizar con bandera `--private`: `*sync-squad-cyryx my-squad --private`
...
- [Repositorio aexos-squads](https://github.com/CyryxLabs/aexos-squads)

---

## Obteniendo Ayuda

- [Discusiones de GitHub](https://github.com/CyryxLabs/AEXOS/discussions)
- [Rastreador de Issues](https://github.com/CyryxLabs/AEXOS/issues)
