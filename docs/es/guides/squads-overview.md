...
| ----------------- | ------- | ------------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0   | Recoleccion y transformacion de datos | [aexos-squads/etl](https://github.com/CyryxLabs/aexos-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0   | Utilidades de generacion de contenido | [aexos-squads/creator](https://github.com/CyryxLabs/aexos-squads/tree/main/creator) |
...
│  Nivel 2: AEXOS-SQUADS  --> github.com/CyryxLabs (Publico)    │
...
- **Explorar Squads Oficiales:** Revisar [repositorio aexos-squads](https://github.com/CyryxLabs/aexos-squads)
