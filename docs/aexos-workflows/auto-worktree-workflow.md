...
flowchart TB
    ...
    PF3 -->|Existe| PF4
    PF3 -->|Não existe| ERR3[Erro: AEXOS incompleto]
...
**Estrutura Criada:**
```
.aexos/worktrees/{storyId}/     # Diretório de trabalho
...
| Propriedade | Valor |
|-------------|-------|
| **Localização** | `.aexos-core/development/tasks/create-worktree.md` |
| **Agente** | @devops (Polaris) |
| **Versão** | 1.0 |
| **Story** | 1.3 |
...
3. Aumentar limite (se necessário) em `.aexos/config.yaml`
...
|--------|------|-------|------------|
| 1.0 | 2026-01-28 | @architect (Vega) | Versão inicial |

---

*Documentação gerada automaticamente pelo AEXOS-FULLSTACK*
