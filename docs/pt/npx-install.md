...
Sempre execute `npx github:CyryxLabs/AEXOS install` **a partir do diretório do seu projeto**:
...
Veja: https://aexos-core.dev/docs/npx-install
```
...
- Documentação: https://aexos-core.dev/docs
