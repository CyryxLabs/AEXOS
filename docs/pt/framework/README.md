...
**Destino de Migração:** Q2 2026 → repositório `CyryxLabs/AEXOS`
...
**IMPORTANTE**: Estes documentos agora estão no repositório `CyryxLabs/AEXOS`. A migração do antigo org `cyryx/aexos-core` foi concluída em dezembro de 2024 como parte do OSR-9 (Architecture Core).

### Cronograma de Migração

- **Fase 1 (Q1 2026 - Story 6.1.2.6):** Docs do framework separados em `docs/framework/`
- **Fase 2 (Q4 2024):** Repositório migrado para `CyryxLabs/AEXOS` (OSR-9)
...
- **Ciclo de vida**: Vive no repositório `CyryxLabs/AEXOS`
