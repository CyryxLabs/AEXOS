...
| ------ | ---------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------- |
| 1.0    | 2025-01-15 | Documentação inicial de source tree                                                                                     | Vega (architect) |
| 1.1    | 2025-12-14 | Atualizado org para CyryxLabs, substituído Squads pelo sistema Squads [Story 6.10]                                       | Vulcan (dev)        |
| 2.0    | 2025-12-15 | Atualização maior para refletir arquitetura modular (cli/, core/, development/, infrastructure/, product/) [Story 6.13] | Themis (PO)         |
