...
| Campo AEXOS type      | Ausente       | `cyryx.type: squad`         |
| Versão mínima        | Ausente       | `cyryx.minVersion: "2.1.0"` |
...
- Adiciona campos `cyryx` ausentes ao manifesto
...
- [ ] `cyryx.type` é `"squad"`
- [ ] `cyryx.minVersion` é `"2.1.0"` ou superior
