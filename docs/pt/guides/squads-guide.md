...
│  Nível 2: AEXOS-SQUADS  → github.com/CyryxLabs (Público/Free) │
│  Nível 3: AEXOS API   → api.cyryx.dev      (Marketplace)  │
└─────────────────────────────────────────────────────────────┘
```
...
| -------------------------------------------------------------------------- | ------ | ---------------------------------- |
| [etl-squad](https://github.com/CyryxLabs/aexos-squads/tree/main/etl)         | 2.0.0  | Coleta e transformação de dados    |
| [creator-squad](https://github.com/CyryxLabs/aexos-squads/tree/main/creator) | 1.0.0  | Utilitários de geração de conteúdo |
...
Isso cria um PR para [CyryxLabs/aexos-squads](https://github.com/CyryxLabs/aexos-squads).

### Nível 3: AEXOS Marketplace
...
3. **Adicionar Campos** - `cyryx.type`, `cyryx.minVersion`
...
# - cyryx.type: deve ser "squad"
# - cyryx.minVersion: deve ser semver válido
```
...
3. Re-publicar: `*publish-squad` ou `*sync-squad-cyryx`
...
- **Nível 3**: Sincronize com flag `--private`: `*sync-squad-cyryx my-squad --private`
...
- [Repositório aexos-squads](https://github.com/CyryxLabs/aexos-squads)
