...
| ----------------- | ------ | ---------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0  | Coleta e transformação de dados    | [aexos-squads/etl](https://github.com/CyryxLabs/aexos-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0  | Utilitários de geração de conteúdo | [aexos-squads/creator](https://github.com/CyryxLabs/aexos-squads/tree/main/creator) |
...
│  Nível 2: AEXOS-SQUADS  --> github.com/CyryxLabs (Público)     │
...
- **Explore Squads Oficiais:** Confira o [repositório aexos-squads](https://github.com/CyryxLabs/aexos-squads)
