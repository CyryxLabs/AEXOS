...
2. **AEXOS Marketplace** - Squads premium via API AEXOS
...
| **Compatibilidade AEXOS** | `cyryx.minVersion: "2.1.0"` ou superior |
...
Isso irá:
1. Fazer fork de `CyryxLabs/aexos-squads` (se necessário)
...
## Publicando no AEXOS Marketplace
...
- **Perguntas**: [GitHub Discussions](https://github.com/CyryxLabs/AEXOS/discussions)
