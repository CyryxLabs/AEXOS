...
| ---------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------- |
| **@analyst** (Sirius)         | 🔍    | Pesquisa de mercado, análise competitiva, brainstorming, extração de padrões                                       | Criação de PRD, arquitetura, stories            |
| **@pm** (Janus)             | 📋    | PRD, epics, estratégia de produto, coleta de requisitos, escrita de specs                                          | Pesquisa, arquitetura, stories detalhadas       |
| **@architect** (Vega)        | 🏛️    | Arquitetura de sistema, design de API, stack tecnológica, avaliação de complexidade, planejamento de implementação | Pesquisa, PRD, schema de banco de dados         |
| **@data-engineer** (Ceres)    | 📊    | Schema de banco de dados, RLS, migrations, otimização de queries                                                   | Arquitetura de app, seleção de tecnologia de BD |
| **@sm** (Chronos)              | 🌊    | User stories, planejamento de sprint, refinamento de backlog                                                       | PRD, epics, pesquisa, implementação             |
| **@dev** (Vulcan)               | 💻    | Implementação de story, codificação, testes, execução de subtasks, recuperação                                     | Criação de story, deploy                        |
| **@qa** (Argus)              | 🧪    | Code review, testes, garantia de qualidade, crítica de spec, revisão estruturada                                   | Implementação                                   |
| **@po** (Themis)                | 🎯    | Gerenciamento de backlog, critérios de aceitação, priorização                                                      | Criação de epic, arquitetura                    |
| **@ux-design-expert** (Nova) | 🎨    | Design UI/UX, wireframes, design systems                                                                           | Implementação                                   |
| **@devops** (Polaris)           | ⚙️    | Git ops, criação de PR, deploy, CI/CD, gerenciamento de worktrees, migrações                                       | Git local, implementação                        |
| **@aexos-master** (Zeus)     | 👑    | Desenvolvimento do framework, orquestração multi-agente                                                            | Tarefas rotineiras (use agentes especializados) |

---

## 🤖 Comandos ADE por Agente (v2.2.0)

### @devops (Polaris) - Infraestrutura & Operações
...
### @architect (Vega) - Arquitetura de Sistema
...
### @analyst (Sirius) - Pesquisa & Análise
...
### @qa (Argus) - Garantia de Qualidade
