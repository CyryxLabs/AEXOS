...
- `@CyryxLabs/maintainers` - Maintainers gerais (acesso de escrita)
- `@CyryxLabs/core-team` - Desenvolvedores core do framework
- `@CyryxLabs/devops` - CI/CD e infraestrutura
