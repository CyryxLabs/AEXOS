...
**Aviso de Migração:** Este documento será migrado para o repositório `CyryxLabs/AEXOS` no Q2 2026 (veja Decisão 005)
...
│
├── stories/                           # Stories de desenvolvimento
│   ├── cyryx migration/                # Stories de migração AEXOS
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Exemplo: docs/stories/cyryx migration/story-6.1.2.6.md
...
| ------ | ---------- | --------------------------------------------------------------------------------- | ---------------- |
| 1.0    | 2025-01-15 | Documentação inicial da árvore de código                                          | Vega (architect) |
| 1.1    | 2025-12-14 | Atualizado org para CyryxLabs, substituído Squads pelo sistema Squads [Story 6.10] | Vulcan (dev)        |
