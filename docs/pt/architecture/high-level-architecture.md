...
| ------ | --------------- | ------------ | ------------------------- |
| Vulcan    | `dev`           | Builder      | Implementação de código   |
| Argus  | `qa`            | Guardian     | Garantia de qualidade     |
| Vega   | `architect`     | Architect    | Arquitetura técnica       |
| Nova   | `po`            | Visionary    | Backlog do produto        |
| Kai    | `pm`            | Balancer     | Estratégia de produto     |
| Chronos  | `sm`            | Facilitator  | Facilitação de processos  |
| Zara   | `analyst`       | Explorer     | Análise de negócios       |
| Ceres   | `data-engineer` | Architect    | Engenharia de dados       |
