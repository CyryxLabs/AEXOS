...
|------|-------|------------------|
| Principal | @dev (Vulcan) | Implementar scripts e tarefas |
| Suporte | @qa (Argus) | Testar implementação |
| Revisão | @architect (Vega) | Revisão de arquitetura |
