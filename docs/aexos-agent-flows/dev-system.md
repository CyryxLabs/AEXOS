...
| Arquivo | Propósito |
|---------|-----------|
| `.aexos-core/development/agents/dev.md` | Definição core do agente @dev (persona, comandos, workflows) |
...
| `.aexos-core/development/scripts/unified-activation-pipeline.js` | Pipeline canonico de ativacao e greeting |
