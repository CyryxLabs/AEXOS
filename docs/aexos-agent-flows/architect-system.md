...
| `.aexos-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklists de validação |
...
| Arquivo | Propósito |
|---------|-----------|
| `.aexos-core/development/agents/architect.md` | Definição core do agente Architect |
