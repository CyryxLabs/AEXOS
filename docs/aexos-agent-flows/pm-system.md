...
| Arquivo | Propósito |
|---------|-----------|
| `.aexos-core/development/agents/pm.md` | Definição core do agente PM |
...
| `.aexos-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validação de checklists |
...
| Arquivo | Propósito |
|---------|-----------|
| `.aexos-core/product/checklists/pm-checklist.md` | Checklist de validação de PRD |
