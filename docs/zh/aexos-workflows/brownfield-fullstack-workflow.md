...
| 代理 | 名称 | 工作流中的角色 | 步骤 |
|------|------|--------------|------|
| @analyst | Sirius | 范围分类、文档验证 | 1, 3 |
| @architect | Vega | 项目文档、架构设计 | 4, 6, 7 |
| @pm | Janus | PRD创建、史诗和简单故事 | 2, 5, 6 |
| @po | Themis | 工件验证、分片、回顾 | 8, 10, 17 |
| @sm | Chronos | 详细故事创建 | 11 |
| @dev | Vulcan | 故事实现 | 13, 15 |
| @qa | Argus | 实现审查 | 14 |
