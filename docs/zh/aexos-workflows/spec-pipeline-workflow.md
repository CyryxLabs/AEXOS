...
graph LR
    subgraph AGENTS["Spec 流水线代理"]
        ...
        AR["@architect<br/>Vega<br/>架构师"]
        AN["@analyst<br/>Sirius<br/>业务分析师"]
...
| 代理 | ID | 名字 | 流水线中的角色 | 阶段 |
|------|-----|------|-----------------|------|
| @pm | pm | Janus | 产品经理 | 1 (收集), 4 (规范), 5b (修订) |
| @architect | architect | Vega | 系统架构师 | 2 (评估), 6 (计划) |
| @analyst | analyst | Sirius | 业务分析师 | 3 (研究) |
| @qa | qa | Argus | 测试架构师 | 5 (批评), 5c (批评 2) |
