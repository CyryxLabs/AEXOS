...
| 代理 | 名称 | 角色 | 主要命令 |
|------|------|------|---------|
| `@analyst` | Sirius | 业务分析师 | `*create-project-brief`, `*brainstorm`, `*research` |
| `@pm` | Janus | 产品经理 | `*create-prd`, `*shard-prd`, `*create-epic` |
| `@ux-expert` | Uma | UX/UI 设计师 | `*create-front-end-spec`, `*generate-ui-prompt`, `*wireframe` |
| `@architect` | Vega | 系统架构师 | `*create-front-end-architecture`, `*document-project` |
| `@po` | Themis | 产品所有者 | `*execute-checklist-po`, `*shard-doc`, `*validate-story-draft` |
| `@sm` | Chronos | Scrum 大师 | `*draft`, `*story-checklist` |
| `@dev` | Vulcan | 全栈开发人员 | `*develop`, `*run-tests`, `*apply-qa-fixes` |
| `@qa` | Argus | 测试架构师 | `*review`, `*gate`, `*test-design` |
