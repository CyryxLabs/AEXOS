...
| 图标 | ID | 名称 | 职位 | 工作流中的角色 |
|------|-----|------|------|---------------|
| @architect | architect | Vega | 整体系统架构师 | 初始分析和棕地架构 |
| @pm | pm | Janus | 产品经理 | 创建棕地PRD |
| @ux-expert | ux-design-expert | Iris | UX/UI设计师 | 前端规范 |
| @po | po | Themis | 产品所有者 | 验证、分片、回顾 |
| @sm | sm | Chronos | 敏捷主管 | 故事创建 |
| @analyst | analyst | Sirius | 业务分析师 | 故事审查（可选） |
| @dev | dev | Vulcan | 全栈开发人员 | 实现 |
| @qa | qa | Argus | 测试架构师 | 质量审查（可选） |
...
| 代理 | 文件 | 文档 |
|------|------|------|
| @architect | `.aexos-core/development/agents/architect.md` | Vega - 整体系统架构师 |
| @pm | `.aexos-core/development/agents/pm.md` | Janus - 产品经理 |
| @ux-expert | `.aexos-core/development/agents/ux-design-expert.md` | Iris - UX/UI设计师 |
| @po | `.aexos-core/development/agents/po.md` | Themis - 产品所有者 |
| @sm | `.aexos-core/development/agents/sm.md` | Chronos - 敏捷主管 |
| @analyst | `.aexos-core/development/agents/analyst.md` | Sirius - 业务分析师 |
| @dev | `.aexos-core/development/agents/dev.md` | Vulcan - 全栈开发人员 |
| @qa | `.aexos-core/development/agents/qa.md` | Argus - 测试架构师 |
