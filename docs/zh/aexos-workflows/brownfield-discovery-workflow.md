...
| **阶段** | 3 |
| **阶段名称** | 收集：前端/UX |
| **代理** | `@ux-design-expert` (Iris - Empathizer) |
...
mindmap
  root((棕地项目<br/>发现))
    收集
      architect["@architect<br/>Vega (愿景家)<br/>系统和整合"]
      data-engineer["@data-engineer<br/>Ceres (智者)<br/>数据库"]
      ux-design-expert["@ux-design-expert<br/>Iris (同情者)<br/>前端/UX"]
    验证
      data-engineer2["@data-engineer<br/>审查DB"]
      ux-design-expert2["@ux-design-expert<br/>审查UX"]
      qa["@qa<br/>Argus (守护者)<br/>质量关卡"]
    完成
      architect2["@architect<br/>最终评估"]
      analyst["@analyst<br/>Sirius (解码器)<br/>执行报告"]
      pm["@pm<br/>Janus (战略家)<br/>史诗和故事"]
```
...
| 代理 | ID | 原型 | 主要专长 |
|------|-----|------|---------|
| Vega | `@architect` | 愿景家 | 系统架构、整体设计 |
| Ceres | `@data-engineer` | 智者 | PostgreSQL、Supabase、RLS、迁移 |
| Iris | `@ux-design-expert` | 同情者 | 原子设计、设计令牌、可访问性 |
| Argus | `@qa` | 守护者 | 质量关卡、测试、可追溯性 |
| Sirius | `@analyst` | 解码器 | 研究、分析、ROI |
| Janus | `@pm` | 战略家 | PRD、史诗、优先级 |
