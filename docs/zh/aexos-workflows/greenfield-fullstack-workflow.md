...
| 步骤 | 代理 | 任务 | 输入 | 输出 | 必需 |
|------|------|------|------|------|------|
| 1 | @devops (Polaris) | `environment-bootstrap.md` | `project_name`, `project_path`, `github_org` | `.aexos/config.yaml`, `.aexos/environment-report.json`, `.gitignore`, `README.md`, `package.json` | 是 |
...
|------|------|----------|------|------|------|
| 1 | @analyst (Sirius) | `project-brief-tmpl.yaml` | 用户需求、研究 | `project-brief.md` | 是 |
| 2 | @pm (Janus) | `prd-tmpl.yaml` | `project-brief.md` | `prd.md` | 是 |
| 3 | @ux-expert (Iris) | `front-end-spec-tmpl.yaml` | `prd.md` | `front-end-spec.md` | 是 |
| 4 | @ux-expert (Iris) | `generate-ai-frontend-prompt.md` | `front-end-spec.md` | v0/Lovable 提示 | 可选 |
| 5 | @architect (Vega) | `fullstack-architecture-tmpl.yaml` | `prd.md`, `front-end-spec.md` | `fullstack-architecture.md` | 是 |
| 6 | @pm (Janus) | 更新 | `fullstack-architecture.md` | 更新的 `prd.md` | 条件 |
| 7 | @po (Themis) | `po-master-checklist.md` | 所有工件 | 验证 | 是 |
...
| 步骤 | 代理 | 任务 | 输入 | 输出 | 必需 |
|------|------|------|------|------|------|
| 1 | @po (Themis) | `shard-doc.md` | `docs/prd.md` | 包含分片文件的 `docs/prd/` 文件夹 | 是 |
...
| 步骤 | 代理 | 任务 | 输入 | 输出 | 必需 |
|------|------|------|------|------|------|
| 1 | @sm (Chronos) | `sm-create-next-story.md` | 分片的文档 | `{epic}.{story}.story.md` | 是 |
| 2 | @analyst/@pm | 审阅 | 故事草稿 | 批准的故事 | 可选 |
| 3 | @dev (Vulcan) | `dev-develop-story.md` | 批准的故事 | 实现 | 是 |
| 4 | @qa (Argus) | `qa-review-story.md` | 实现 | 质量保证反馈 | 可选 |
| 5 | @dev (Vulcan) | `apply-qa-fixes.md` | 质量保证反馈 | 应用的更正 | 条件 |
| 6 | @po (Themis) | 回顾 | 完成的史诗 | 回顾 | 可选 |
...
| 代理 | ID | 图标 | 原型 | 责任 |
|------|----|----|------|------|
| Polaris | @devops | ⚡ | 操作员 | 环境引导、Git 推送、发布、CI/CD |
| Sirius | @analyst | 🔍 | 解码器 | 市场研究、头脑风暴、项目简报 |
| Janus | @pm | 📋 | 策略师 | PRD、产品策略、史诗 |
| Uma | @ux-expert | 🎨 | 移情者 | 前端规范、UX、设计系统 |
| Vega | @architect | 🏛️ | 愿景者 | 全栈架构、技术决策 |
| Themis | @po | 🎯 | 平衡者 | 工件验证、待办事项、分片 |
| Chronos | @sm | 🌊 | 促进者 | 故事创建、冲刺规划 |
| Vulcan | @dev | 💻 | 建设者 | 代码实现、测试 |
| Argus | @qa | ✅ | 守卫者 | 质量审阅、测试、关卡 |
