...
我们在 CyryxLabs 非常重视安全。如果您在 AEXOS 中发现安全漏洞，请负责任地报告。
...
1. **GitHub 安全公告**（首选）
   - 前往 [安全公告](https://github.com/CyryxLabs/AEXOS/security/advisories)
   - 点击"报告漏洞"
   - 填写详细信息表单

2. **电子邮件**
   - 发送电子邮件至：security@cyryx.ai
   - 主题行：`[SECURITY] 简要描述`
...
- [GitHub 安全公告](https://github.com/CyryxLabs/AEXOS/security/advisories)
