...
| 包 | 注册表 | 许可证 |
| --- | --- | --- |
| `@cyryx/core` | npm 公开 | MIT |
| `@cyryx/squad-etl` | npm 公开 | MIT |
| `@cyryx/squad-creator` | npm 公开 | MIT |
| `@cyryx/squad-mmos` | npm 公开 | MIT |
| `@cyryx/mcp-presets` | npm 公开 | Apache 2.0 |
...
| Vulcan | `dev` | 构建者 | 代码实现 |
| Argus | `qa` | 守护者 | 质量保证 |
| Vega | `architect` | 架构师 | 技术架构 |
| Nova | `po` | 远见者 | 产品待办 |
| Kai | `pm` | 平衡者 | 产品策略 |
| Chronos | `sm` | 协调者 | 过程协调 |
| Zara | `analyst` | 探索者 | 业务分析 |
| Ceres | `data-engineer` | 架构师 | 数据工程 |
