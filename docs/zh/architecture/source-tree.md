...
**迁移通知**: 此文档将在 Q2 2026 迁移到 `CyryxLabs/AEXOS` 存储库（参见决策 005）
...
│
├── bin/                               # CLI 可执行文件
│   ├── @aexos-squads/core.js              # 主 CLI 入口点
...
### 存储库 3: CyryxLabs/mcp-ecosystem (Apache 2.0)
...
### 存储库 4: CyryxLabs/certified-partners (私有)
...
示例: docs/stories/cyryx migration/story-6.1.2.6.md
...
| 版本 | 日期       | 变更                                                            | 作者            |
| ---- | ---------- | -------------------------------------------------------------- | --------------- |
| 1.0  | 2025-01-15 | 代码树初始文档化                                               | Vega (architect)|
| 1.1  | 2025-12-14 | 更新 org 为 CyryxLabs，用 Squad 系统替换 Squads [Story 6.10]    | Vulcan (dev)       |
