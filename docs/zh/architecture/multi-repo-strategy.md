...
### CyryxLabs/certified-partners(专有)
...
| 包                   | 注册表 | 许可证     | 仓库        |
| -------------------- | ------ | ---------- | ----------- |
| `@cyryx/core`         | npm    | MIT        | aexos-core   |
| `@cyryx/squad-etl`    | npm    | MIT        | aexos-squads |
| `@cyryx/squad-creator`| npm    | MIT        | aexos-squads |
| `@cyryx/squad-mmos`   | npm    | MIT        | aexos-squads |
| `@cyryx/mcp-presets`  | npm    | Apache 2.0 | mcp-ecosystem |
