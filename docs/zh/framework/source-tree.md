...
### 仓库3: CyryxLabs/mcp-ecosystem (Apache 2.0)
...
### 仓库4: CyryxLabs/certified-partners (私有)
...
| 版本 | 日期 | 变更 | 作者 |
| ---- | ---- | ---- | ---- |
| 1.0 | 2025-01-15 | 初始源代码树文档 | Vega (architect) |
| 1.1 | 2025-12-14 | 更新组织为 CyryxLabs，用 Squads 系统替换 Squads [Story 6.10] | Vulcan (dev) |
| 2.0 | 2025-12-15 | 主要更新以反映模块化架构（cli/、core/、development/、infrastructure/、product/）[Story 6.13] | Themis (PO) |
| 3.0 | 2026-01-29 | 添加 ADE（自主开发引擎）部分，记录 Epics 1-7：workflow-intelligence、ADE 脚本、工作流、任务和运行时状态 [ADE 集成] | Vega (architect) |
| 3.1 | 2026-02-06 | 添加数据文件治理部分：记录7个缺失的数据文件及其所有者、填充规则和更新触发器。扩展 .aexos-core/data/ 和 product/data/ 树列表。[Story ACT-8] | Vulcan (dev) |
