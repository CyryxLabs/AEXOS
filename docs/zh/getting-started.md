...
| 代理 | 名称 | 专注领域 |
| --- | --- | --- |
| `@dev` | Vulcan | 代码实现、bug 修复、重构 |
| `@qa` | Argus | 测试、质量门控、代码审查 |
| `@architect` | Vega | 系统设计、技术决策 |
| `@pm` | Bob | PRD、战略、路线图 |
| `@po` | Themis | 待办事项、故事验证、优先级排序 |
| `@sm` | Chronos | 故事创建、冲刺计划 |
| `@analyst` | Alex | 研究、竞争分析 |
| `@data-engineer` | Ceres | 数据库设计、迁移 |
| `@ux-design-expert` | Iris | UI/UX 设计、无障碍访问 |
| `@devops` | Polaris | Git 操作、CI/CD、部署 |
