...
flowchart TB
    ...
    subgraph ARCHITECT_BOX["@architect (Vega) - 架构师"]
        ARCH_DESC["架构设计<br/>技术决策"]
        ARCH_CMDS["命令：<br/>*create-architecture<br/>*document-project"]
    end

    subgraph ANALYST_BOX["@analyst (Sirius) - 分析师"]
