...
本文档描述 **@analyst (Sirius)** 代理的完整系统，包括所有涉及的文件、工作流程、可用命令、模板和代理之间的集成。
...
flowchart TB
    ...
    subgraph ANALYST["@analyst (Sirius) - 业务分析师"]
...
| 代理 | 协作类型 |
|--------|---------------------|
| **@pm (Janus)** | 分析师为 PRD 创建提供研究和分析 |
| **@po (Themis)** | 分析师提供市场见解和竞争分析 |
