...
```
npm ERR! code E404
npm ERR! 404 Not Found - GET https://registry.npmjs.org/@aexos-squads/core
```
...
npm ERR! network request to https://registry.npmjs.org/@aexos-squads/core failed
```
...
# 以详细日志重试
npm install @aexos-squads/core --verbose
```
...
- **GitHub Issues**: [@aexos-squads/core/issues](https://github.com/CyryxLabs/AEXOS/issues)
