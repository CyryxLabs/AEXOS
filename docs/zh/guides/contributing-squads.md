...
2. **AEXOS Marketplace** - 通过AEXOS API的高级Squad
...
| **AEXOS兼容性** | `cyryx.minVersion: "2.1.0"` 或更高 |
...
这将：
1. Fork `CyryxLabs/aexos-squads` （如需要）
2. 用你的Squad创建分支
3. 开启审查PR
...
- **问题**: [GitHub讨论](https://github.com/CyryxLabs/AEXOS/discussions)
- **问题**: [问题跟踪器](https://github.com/CyryxLabs/AEXOS/issues)
- **指南**: 本文档
