...
| 代理 ID          | 名称   | 原型    | 主要责任                           |
| ---------------- | ------ | ------- | ---------------------------------- |
| `@dev`           | Vulcan    | Builder | 代码实现、调试、测试               |
| `@qa`            | Argus  | Guardian| 质量保证、代码审查、测试           |
| `@architect`     | Vega   | Visionary| 系统架构、API 设计                |
| `@pm`            | Janus | Strategist| 产品需求、史诗、战略            |
| `@po`            | Themis    | Champion| 待办事项管理、验收标准             |
| `@sm`            | Chronos  | Facilitator| 冲刺规划、故事创建             |
| `@analyst`       | Sirius  | Explorer| 市场研究、竞争分析                 |
| `@data-engineer` | Ceres   | Architect| 数据库架构、迁移、查询           |
| `@devops`        | Polaris   | Optimizer| CI/CD、部署、git 操作             |
| `@ux-expert`     | Uma    | Creator | UI/UX 设计、线框图                 |
| `@aexos-master`   | Zeus  | Orchestrator| 框架编排、元操作             |
