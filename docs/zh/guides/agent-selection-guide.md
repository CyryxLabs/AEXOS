...
| 代理 | 图标 | 用于 | 不用于 |
|------|------|------|--------|
| **@analyst** (Sirius) | 🔍 | 市场研究、竞争分析、头脑风暴、模式提取 | PRD创建、架构、故事 |
| **@pm** (Janus) | 📋 | PRD、史诗、产品战略、需求收集、规范编写 | 研究、架构、详细故事 |
| **@architect** (Vega) | 🏛️ | 系统架构、API设计、技术栈、复杂度评估、实现规划 | 研究、PRD、数据库架构 |
| **@data-engineer** (Ceres) | 📊 | 数据库架构、RLS、迁移、查询优化 | 应用架构、DB技术选择 |
| **@sm** (Chronos) | 🌊 | 用户故事、冲刺规划、待办事项整理 | PRD、史诗、研究、实现 |
| **@dev** (Vulcan) | 💻 | 故事实现、编码、测试、子任务执行、恢复 | 故事创建、部署 |
| **@qa** (Argus) | 🧪 | 代码审查、测试、质量保证、规范批评、结构化审查 | 实现 |
| **@po** (Themis) | 🎯 | 待办事项管理、验收标准、优先级排序 | 史诗创建、架构 |
| **@ux-design-expert** (Nova) | 🎨 | UI/UX设计、线框图、设计系统 | 实现 |
| **@devops** (Polaris) | ⚙️ | Git操作、PR创建、部署、CI/CD、工作树管理、迁移 | 本地Git、实现 |
| **@aexos-master** (Zeus) | 👑 | 框架开发、多代理编排 | 日常任务（使用专门代理） |

---

## 🤖 ADE命令按代理 (v2.2.0)

### @devops (Polaris) - 基础设施与运营
