...
| Arquivo | Proposito |
|---------|-----------|
| `.aexos-core/development/agents/analyst.md` | Definicao core do agente Analyst |
...
| `.aexos-core/development/tasks/document-project.md` | `*create-project-brief` | Documentacao de projetos existentes |
...
|--------|---------------------|
| **@pm (Janus)** | Analyst fornece pesquisa e analise para criacao de PRD |
