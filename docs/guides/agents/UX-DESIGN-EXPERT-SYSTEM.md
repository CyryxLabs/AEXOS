# Sistema UX-Design-Expert AEXOS
...
Este documento descreve o sistema completo do agente **UX-Design Expert (Iris)**, incluindo todos os arquivos envolvidos, fluxos de trabalho, comandos disponiveis, integracoes com outros agentes e workflows AEXOS.
...
| Arquivo | Proposito |
|---------|-----------|
| `.aexos-core/development/agents/ux-design-expert.md` | Definicao completa do agente (persona, comandos, workflows) |
| `.claude/commands/AEXOS/agents/ux-design-expert.md` | Comando Claude Code para ativar @ux-design-expert |
...
|---------|---------|-----------|
| `.aexos-core/development/tasks/ux-user-research.md` | `*research` | Conduzir pesquisa de usuario, criar personas e jornadas |
| `.aexos-core/development/tasks/ux-create-wireframe.md` | `*wireframe` | Criar wireframes low/mid/high fidelity |
| `.aexos-core/development/tasks/generate-ai-frontend-prompt.md` | `*generate-ui-prompt` | Gerar prompts para v0.dev, Lovable.ai |
| `.aexos-core/development/tasks/create-doc.md` | `*create-front-end-spec` | Criar especificacao frontend detalhada |

#### Fase 2: Design System Audit (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.aexos-core/development/tasks/audit-codebase.md` | `*audit {path}` | Escanear codebase para redundancias UI |
| `.aexos-core/development/tasks/consolidate-patterns.md` | `*consolidate` | Reduzir redundancia com clustering HSL |
| `.aexos-core/development/tasks/generate-shock-report.md` | `*shock-report` | Gerar relatorio visual HTML |

#### Fase 3: Design Tokens & Setup (7 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.aexos-core/development/tasks/extract-tokens.md` | `*tokenize` | Extrair design tokens (YAML, JSON, CSS, DTCG) |
| `.aexos-core/development/tasks/setup-design-system.md` | `*setup` | Inicializar estrutura do design system |
| `.aexos-core/development/tasks/generate-migration-strategy.md` | `*migrate` | Gerar estrategia de migracao em 4 fases |
| `.aexos-core/development/tasks/tailwind-upgrade.md` | `*upgrade-tailwind` | Upgrade para Tailwind CSS v4 |
| `.aexos-core/development/tasks/audit-tailwind-config.md` | `*audit-tailwind-config` | Validar configuracao Tailwind |
| `.aexos-core/development/tasks/export-design-tokens-dtcg.md` | `*export-dtcg` | Exportar tokens W3C DTCG |
| `.aexos-core/development/tasks/bootstrap-shadcn-library.md` | `*bootstrap-shadcn` | Instalar Shadcn/Radix UI |

#### Fase 4: Atomic Component Building (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.aexos-core/development/tasks/build-component.md` | `*build {component}` | Construir componente atomico (React + TypeScript) |
| `.aexos-core/development/tasks/compose-molecule.md` | `*compose {molecule}` | Compor molecule de atoms existentes |
| `.aexos-core/development/tasks/extend-pattern.md` | `*extend {component}` | Adicionar variante a componente existente |

#### Fase 5: Quality & Documentation (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.aexos-core/development/tasks/generate-documentation.md` | `*document` | Gerar documentacao do pattern library |
| `.aexos-core/development/tasks/calculate-roi.md` | `*calculate-roi` | Calcular ROI e cost savings |
| `.aexos-core/development/checklists/accessibility-wcag-checklist.md` | `*a11y-check` | Auditoria de acessibilidade WCAG |

#### Tasks Universais (2 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.aexos-core/development/tasks/ux-ds-scan-artifact.md` | `*scan {path\|url}` | Analisar HTML/React para extrair padroes |
| `.aexos-core/development/tasks/integrate-Squad.md` | `*integrate {squad}` | Conectar com expansion squad |

### Templates

| Arquivo | Proposito |
|---------|-----------|
| `.aexos-core/development/templates/front-end-spec-tmpl.yaml` | Template de especificacao frontend |
| `.aexos-core/development/templates/tokens-schema-tmpl.yaml` | Schema de design tokens |
| `.aexos-core/development/templates/component-react-tmpl.tsx` | Template de componente React |
| `.aexos-core/development/templates/state-persistence-tmpl.yaml` | Template de persistencia de estado |
| `.aexos-core/development/templates/shock-report-tmpl.html` | Template de shock report HTML |
| `.aexos-core/development/templates/migration-strategy-tmpl.md` | Template de estrategia de migracao |
| `.aexos-core/development/templates/token-exports-css-tmpl.css` | Template de export CSS |
| `.aexos-core/development/templates/token-exports-tailwind-tmpl.js` | Template de export Tailwind |
| `.aexos-core/development/templates/ds-artifact-analysis.md` | Template de analise de artefato |

### Checklists

| Arquivo | Proposito |
|---------|-----------|
| `.aexos-core/development/checklists/pattern-audit-checklist.md` | Checklist de auditoria de padroes |
| `.aexos-core/development/checklists/component-quality-checklist.md` | Checklist de qualidade de componente |
| `.aexos-core/development/checklists/accessibility-wcag-checklist.md` | Checklist WCAG AA/AAA |
| `.aexos-core/development/checklists/migration-readiness-checklist.md` | Checklist de readiness para migracao |

### Data Files

| Arquivo | Proposito |
|---------|-----------|
| `.aexos-core/development/data/technical-preferences.md` | Preferencias tecnicas padrao |
| `.aexos-core/development/data/atomic-design-principles.md` | Principios Atomic Design |
| `.aexos-core/development/data/design-token-best-practices.md` | Best practices de design tokens |
| `.aexos-core/development/data/consolidation-algorithms.md` | Algoritmos de consolidacao |
| `.aexos-core/development/data/roi-calculation-guide.md` | Guia de calculo de ROI |
| `.aexos-core/development/data/integration-patterns.md` | Padroes de integracao |
| `.aexos-core/development/data/wcag-compliance-guide.md` | Guia de conformidade WCAG |

### Workflows Relacionados

| Arquivo | Proposito |
|---------|-----------|
| `.aexos-core/development/workflows/design-system-build-quality.yaml` | Pipeline pos-migracao (build, docs, a11y, ROI) |
| `.aexos-core/development/workflows/brownfield-ui.yaml` | Workflow para UI brownfield |
| `.aexos-core/development/workflows/brownfield-discovery.yaml` | Discovery para projetos existentes |
| `.aexos-core/development/workflows/greenfield-ui.yaml` | Workflow para UI greenfield |
