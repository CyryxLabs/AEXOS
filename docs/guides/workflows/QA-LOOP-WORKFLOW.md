...
**Localizacao:** `.aexos-core/development/tasks/qa-review-story.md`
...
**Localizacao:** `.aexos-core/development/tasks/qa-create-fix-request.md`
...
**Localizacao:** `.aexos-core/development/tasks/dev-apply-qa-fixes.md`
