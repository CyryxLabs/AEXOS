...
1. **Load persona** from `.grok/agents/aexos-squad-creator.md` (session agent profile).
2. **Source of truth** for full commands/tasks: `.aexos-core/development/agents/squad-creator.md`
